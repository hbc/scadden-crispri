...
So we'll fix that here, leaving the derived names the same and just switching
the library.

```{r fix-swap}
a_samples$library[a_samples$derived %in% c("HM_B_pre_1", "HM_B_pre_2")] = "A"
b_samples$library[b_samples$derived %in% c("HM_A_pre_1", "HM_A_pre_2")] = "B"
```
